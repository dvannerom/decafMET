...
h_uperp_raw_vs_qt = inFile.Get("uperp_raw_vs_qt")
h_uperp_pf_vs_qt = inFile.Get("uperp_pf_vs_qt")
h_uperp_puppi_vs_qt = inFile.Get("uperp_puppi_vs_qt")

resolution_raw = resolution(h_uperp_raw_vs_qt)
resolution_pf = resolution(h_uperp_pf_vs_qt)
resolution_puppi = resolution(h_uperp_puppi_vs_qt)
...
resolution_raw.GetXaxis().SetTitle("q_{T} (GeV)")
...
canvas.SaveAs("plots/resolution_uperp_qt.png")
canvas.SaveAs("plots/resolution_uperp_qt.pdf")

...
h_upar_raw_vs_qt = inFile.Get("upar_raw_vs_qt")
h_upar_pf_vs_qt = inFile.Get("upar_pf_vs_qt")
h_upar_puppi_vs_qt = inFile.Get("upar_puppi_vs_qt")

resolution_raw = resolution(h_upar_raw_vs_qt)
resolution_pf = resolution(h_upar_pf_vs_qt)
resolution_puppi = resolution(h_upar_puppi_vs_qt)
...
canvas.SaveAs("plots/resolution_upar_qt.png")
canvas.SaveAs("plots/resolution_upar_qt.pdf")

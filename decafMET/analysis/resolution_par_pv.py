...
inFile = ROOT.TFile.Open("EGamma.root","READ")
h_upar_raw_vs_pv = inFile.Get("upar_raw_vs_pv")
h_upar_pf_vs_pv = inFile.Get("upar_pf_vs_pv")
h_upar_puppi_vs_pv = inFile.Get("upar_puppi_vs_pv")

resolution_raw = resolution(h_upar_raw_vs_pv)
resolution_pf = resolution(h_upar_pf_vs_pv)
resolution_puppi = resolution(h_upar_puppi_vs_pv)

# Drawing
tdrstyle.setTDRStyle()

#change the CMS_lumi variables (see CMS_lumi.py)
CMS_lumi.lumi_13TeV = "X fb^{-1}"
...
resolution_raw.GetYaxis().SetTitle("#sigma(u_{#parallel}) (GeV)")
...
leg.SetHeader("#gamma+jets (2018)","C");
...
canvas.SaveAs("plots/resolution_upar_pv.png")
canvas.SaveAs("plots/resolution_upar_pv.pdf")
